import { sum, subtract, multiply, divide, square, percentage, power } from 'utils/arithmeticOperations';
import { ERROR } from 'constants/constants';

describe('basic arithmetic operations: addition, subtraction, multiplication, division, square, percentage (EXCLUDE brackets)', () => {
    test('addition', () => {
        // int
    ...
    test('power', () => {
        expect<number | string>(power(2, 2)).toEqual<number>(4);
        expect<number | string>(power(4, 2)).toEqual<number>(16);
        expect<number | string>(power(-4, 4)).toEqual<string>(ERROR);
    });
});
